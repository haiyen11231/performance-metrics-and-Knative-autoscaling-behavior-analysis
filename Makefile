...
# 	docker build -t haiyen11231/lab-project-server:1.0 -f server/Dockerfile .
	docker build -t haiyen11231/worker:1.0 -f server/Dockerfile .

build-client:
# 	docker build -t haiyen11231/lab-project-client:1.0 -f client/Dockerfile .
	docker build -t haiyen11231/load-driver:1.0 -f client/Dockerfile .

push-server:
	docker push haiyen11231/worker:1.0

push-client:
	docker push haiyen11231/load-driver:1.0
